...
import os
import shutil
from modules import instructor, player, rejoin
import time
...
def welcome_instructor():
    ...
    **WARNING:  Do NOT close your browser while playing iBIKE! If you do close your tab by accident or get disconnect for any reason, you will need to restart the game.**
    """
	)
