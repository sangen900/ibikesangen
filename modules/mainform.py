...
def main_form():
    ...
    # Show the checkbox to manually indicate form completion
    form_status[user_selected_page] = st.checkbox(f"{user_selected_page} Completed", form_status[user_selected_page])
